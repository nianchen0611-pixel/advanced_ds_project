...
```text
User Question
→ LLM selects the finance analysis tool
→ Python tool computes the result
→ Grounded response is displayed in Streamlit
```

The app also supports anomaly detection and category-level spending analysis.
